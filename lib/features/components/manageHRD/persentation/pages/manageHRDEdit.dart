...
class Managehrdedit extends StatefulWidget {
  ...
  const Managehrdedit({super.key, required this.data});

  @override
  _Managehrdedit createState() => _Managehrdedit(data: data);
}

class _Managehrdedit extends State<Managehrdedit> {
  final PreferenceMV data;

  _Managehrdedit({required this.data});
