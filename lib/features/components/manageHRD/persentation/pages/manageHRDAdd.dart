...
class Managehrdadd extends StatefulWidget {
  const Managehrdadd({super.key});

  @override
  _Managehrdadd createState() => _Managehrdadd();
}

class _Managehrdadd extends State<Managehrdadd> {
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        PreferenceRequest newPreference = PreferenceRequest(
          idUser: idUser,
        ...
        PreferenceResponse response = await _profileUseCase.addPreference(
          newPreference,
        );
