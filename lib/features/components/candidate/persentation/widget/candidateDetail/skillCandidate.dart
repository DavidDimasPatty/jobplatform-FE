...
class SkillCandidate extends StatefulWidget {
  final List<SkillMV> dataSkills;
  const SkillCandidate({super.key, required this.dataSkills});

  @override
  _SkillStateCandidate createState() => _SkillStateCandidate(dataSkills);
}

class _SkillStateCandidate extends State<SkillCandidate> {
  final List<SkillMV> dataSkills;

  _SkillStateCandidate(this.dataSkills);
